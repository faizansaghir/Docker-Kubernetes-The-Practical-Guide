...
- **Utility container with docker compose**
  - Instead of writing long commands to map binds and run a commands, we can use docker compose to achieve this. Sample [docker-compose.yaml](https://github.com/faizansaghir/Docker-Kubernetes-The-Practical-Guide/blob/main/Module%207/utilit-with-compose/docker-compose.yaml)
